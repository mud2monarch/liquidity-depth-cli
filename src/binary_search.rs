...
pub fn calculate_output_for_slippage_tolerance( // @dev TODO: Why did I specify this for type S: ProtocolSim? Can't I just say state: &ProtocolSim?
...
pub fn check_slippage_under_target(
    ...
    info!("check_slippage_under_target ---- \n slippage: {:?}\n target_slippage: {:?}\n targ_num: {:?}\n targ_den: {:?}", slippage, target_slippage, targ_num, targ_den);
